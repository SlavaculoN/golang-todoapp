...
import (
	...
	"github.com/SlavaculoN/golang-todoapp/internal/core/domain"
	core_logger "github.com/SlavaculoN/golang-todoapp/internal/core/logger"
	core_http_request "github.com/SlavaculoN/golang-todoapp/internal/core/transport/http/request"
	core_http_response "github.com/SlavaculoN/golang-todoapp/internal/core/transport/http/response"
	core_http_types "github.com/SlavaculoN/golang-todoapp/internal/core/transport/http/types"
	...
	if r.PhoneNumber.Set {
		if r.PhoneNumber.Value != nil {
			...
			if !strings.HasPrefix(*r.PhoneNumber.Value, "+") {
				return fmt.Errorf("`PhoneNumber` must start '+' symbol")
			}
		}
	}
...
func (h *UsersHTTPHandler) PatchUser(rw http.ResponseWriter, r *http.Request) {
	...
	userPatch := userPatchFromReqest(request)
...
func userPatchFromReqest(request PatchUserRequest) domain.UserPatch {
